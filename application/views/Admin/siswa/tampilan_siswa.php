 <div class="row">
     <div class="col-md">
         <div class="alert alert-success" role="alert">
             <h4 class="text-center text-uppercase font-weight-bolder">Siswa</h4>
         </div>
     </div>
 </div>
 <div class="row">
     <div class="col-md">
         <div class="card">
             <div class="card-body">
                 ...
                 <a class="btn btn-danger btn-sm text-uppercase font-weight-bolder" href="<?= base_url() ?>Dashboard/hapus_all_siswa">Hapus Siswa</a>
             </div>
         </div>
     </div>
 </div>
                     ...
                     <table class="table table-striped table-bordered" id="dataTable" width="100%" cellspacing="0">
                         <thead class="text-center">
                             <tr class="">
                                 ...
                                 <th scope="col">
                                     <h6 class="font-weight-bold text-uppercase">Jumlah siswa</h6>
                                 </th>
                                 <th scope="col">
                             ...
                             <tr>
                                 <?php
                                    ...
                                    ?>
                                     ...
                                     <td>
                                         <h6 class="text-uppercase"><?= $row['jumlah_siswa']; ?> Siswa</h6>
                                     </td>
                                     <td>
                                         <h5 class="">
                                             <a class="btn btn-primary btn-sm text-uppercase font-weight-bolder" href="<?= base_url() ?>Dashboard/detail_siswa/<?= $row['id_ta']; ?>">detail</a>
                                         </h5>
                                     </td>
                             </tr>
                         <?php } ?>
